...
`concierge` is a Python hands-on repository for experimenting with Microsoft
Foundry models through LangChain and LangGraph-oriented workflows. The current
